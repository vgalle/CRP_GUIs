...
================================
-run_Relocations_Optimizer.sh (shell script for temporarily setting environment variables 
 and executing the application)
   -to run the shell script, type
   
       ./run_Relocations_Optimizer.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v901, run the shell script as:
       ...
       ./run_Relocations_Optimizer.sh /mathworks/home/application/v901
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_Relocations_Optimizer.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
   -if end users are unable to download the MATLAB Runtime using the above  
    link, include it when building your component by clicking 
    the "Runtime downloaded from web" link in the Deployment Tool
-The Macintosh bundle directory structure Relocations_Optimizer.app 
   -this can be gathered up using the zip command 
    zip -r Relocations_Optimizer.zip Relocations_Optimizer.app
    or the tar command 
    tar -cvf Relocations_Optimizer.tar Relocations_Optimizer.app
-This readme file 
...
If it is defined, set it to the concatenation of these strings:
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_Relocations_Optimizer.sh 
